...
const PAGES = [
  ...
  {
    url: '/walk-in-gp-newbridge/', file: 'walk-in.html', crumb: 'Walk-in GP Newbridge', parent: '/', priority: 0.95, image: SOCIAL_CLINIC,
  ...
  {
    url: '/family-gp/', file: 'new-patients.html', crumb: 'Family GP', parent: '/', priority: 0.9, image: SOCIAL_CLINIC,
  ...
  {
    url: '/contact/', file: 'contact.html', crumb: 'Contact', parent: '/', priority: 0.8, image: SOCIAL_CLINIC,
