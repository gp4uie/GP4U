...
const TEXT = [
  ...
  T('home.hero.lead', 'index.html', 'Home page', 'Sentence under the headline', 'Online when you need it. In person when you need us.', { long: true }),
  ...
  T('home.online3.eyebrow', 'index.html', 'Home page', 'Online 3-step section: small heading', 'Online GP', { nth: 3 }),
