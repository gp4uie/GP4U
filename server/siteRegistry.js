...
const TEXT = [
  // ---------------------------------------------------------------- Home page
  T('home.pill', 'index.html', 'Home page', 'Small tag above the headline', 'GP4U · Online GP across Ireland'),
  T('home.hero.title', 'index.html', 'Home page', 'Main headline', 'One tap. Real care.'),
  T('home.hero.lead', 'index.html', 'Home page', 'Sentence under the headline', 'Online GP care from wherever you are in Ireland.', { long: true }),
  T('home.btn.online', 'index.html', 'Home page', 'Top button 1', 'See a GP online'),
  ...
  T('home.chip.2', 'index.html', 'Home page', 'Trust chip 2', 'Online GP 7 days'),
  ...
  T('home.hours.online.title', 'index.html', 'Home page', 'Online GP box: title', 'Online GP'),
  ...
  T('home.card.online.go', 'index.html', 'Home page', 'Online card: link text', 'Online GP', { nth: 1 }),
  ...
  T('home.how.title', 'index.html', 'Home page', 'How it works: heading', 'GP care when you need it.'),
  T('home.how.lead', 'index.html', 'Home page', 'How it works: sentence under the heading', 'Walk in and see a GP at our Newbridge clinic.'),
  ...
  T('home.online3.eyebrow', 'index.html', 'Home page', 'Online 3-step section: small heading', 'Online GP', { nth: 2 }),
  T('home.online3.title', 'index.html', 'Home page', '3-step section: heading', 'See a GP online in 3 simple steps'),
  T('home.online3.1.title', 'index.html', 'Home page', 'Online step 1: title', 'Choose your consultation'),
  T('home.online3.1.text', 'index.html', 'Home page', 'Online step 1: text', "Tell us what it's about — we'll show the price upfront.", { long: true }),
  T('home.online3.2.title', 'index.html', 'Home page', 'Online step 2: title', 'Select a convenient time'),
  T('home.online3.2.text', 'index.html', 'Home page', 'Online step 2: text', 'Pick a video or phone slot that suits you, and pay securely.', { long: true }),
  T('home.online3.3.title', 'index.html', 'Home page', 'Online step 3: title', 'Speak to your GP'),
  T('home.online3.3.text', 'index.html', 'Home page', 'Online step 3: text', 'Join from your phone or computer at your appointment time.', { long: true }),
  T('home.online3.btn', 'index.html', 'Home page', '3-step section: button', 'Book an Online GP'),
  ...
  T('home.cta.title', 'index.html', 'Home page', 'Bottom band: heading', 'One tap. Real care.', { nth: 1 }),
  T('home.cta.text', 'index.html', 'Home page', 'Bottom band: text', 'See a GP online today, from wherever you are in Ireland.'),
