...
<section class="hero3">
  ...
  <div class="container hero3-inner">
    <div class="hero3-text">
      ...
      <ul class="hero2-meta trust-chips">
        <li>${ico('badge')} Irish-registered GPs</li>
        <li>${ico('clock')} Open 7 days</li>
        <li>${ico('check')} No appointment needed at the clinic</li>
        <li>${ico('lock')} Private &amp; secure</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="sec need" id="choose" style="padding-top:12px;">
  <div class="container">
    <h2 class="need-title">How can we help you today?</h2>
    <div class="need-grid">
      <a class="need-card" href="/online.html">
        <div class="need-body">
          <span class="need-ico">${ico('video')}</span>
          <h3>I want to speak to a GP online</h3>
      ...
      <a class="need-card" href="/walk-in.html">
        <div class="need-body">
          <span class="need-ico">${ico('pin')}</span>
          <h3>I need to see a GP today</h3>
      ...
      <a class="need-card" id="register" href="/new-patients.html">
        <div class="need-body">
          <span class="need-ico">${ico('users')}</span>
          <h3>I want to register with GP4U</h3>
...
<section class="sec">
  <div class="container how-grid">
    <div class="how-main">
      ...
      <p style="margin:22px 0 0;"><a href="/walk-in.html#book-in" class="btn btn-secondary btn-lg">Check in for your visit</a></p>
    </div>
    <a class="banner-card" href="/about.html">
      <img src="/img/clinic/mother-baby.webp" alt="A mother holding her newborn baby in soft window light" loading="lazy" width="1300" height="867">
      <div class="bc-text">
        <h3>Real people. Real care.</h3>
        <p>GP care for you and your family, close to home in Newbridge.</p>
        <span class="btn btn-primary">About GP4U <svg class="ico arrow" viewBox="0 0 24 24" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></span>
      </div>
    </a>
  </div>
</section>
  ...
  <div class="container">
    <article class="panel">
      <div class="panel-text">
        ...
        <h2>Family care, for every stage.</h2>
      ...
      <div class="panel-img"><img src="/img/clinic/family-sofa.webp" alt="A smiling family of three sitting together on a sofa" loading="lazy" width="1500" height="844"></div>
    </article>
  </div>
</section>
...
<section class="sec" id="find-us">
  <div class="container">
    <div class="sec-head center">
      ...
      <h2>Visit our clinic in Newbridge</h2>
    </div>
    ${locationBlock()}
  </div>
</section>
